...
export const ResearchRuns = createEntity('ResearchRuns')
export const ResearchFindings = createEntity('ResearchFindings')
export const RedditExtracts = createEntity('RedditExtracts')
export const ContextDocuments = createEntity('ContextDocuments')
export const CreativeLearnings = createEntity('CreativeLearnings')
export const ScriptIdeas = createEntity('ScriptIdeas')
export const AgentMemory = createEntity('AgentMemory')
